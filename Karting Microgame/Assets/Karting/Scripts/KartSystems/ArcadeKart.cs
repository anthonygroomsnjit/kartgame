...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            Vector3 movement = 10 * fwd * accelInput * finalAcceleration * ((m_HasCollision || GroundPercent > 0.0f) ? 1.0f : 0.0f);
            ...
            Vector3 newVelocity = Rigidbody.velocity * 1.01f + movement * Time.fixedDeltaTime;
