...
public class PickupObject : TargetObject
{
    ...
    void OnCollect(KartGame.KartSystems.ArcadeKart arcadeKart)
    {
        if (CollectSound)
        {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            OnCollect(other.transform.parent.gameObject.GetComponent<KartGame.KartSystems.ArcadeKart>());
        }
    }
}
